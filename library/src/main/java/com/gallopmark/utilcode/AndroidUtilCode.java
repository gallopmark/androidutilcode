...
public final class AndroidUtilCode {
    ...
    static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? AndroidUtilCode.getApp() : topActivity;
        } else {
    ...
    static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(AndroidUtilCode.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    static class ActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
        ...
        private static void fixSoftInputLeaks(final Activity activity) {
            ...
            InputMethodManager imm =
                    (InputMethodManager) AndroidUtilCode.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm == null) return;
    ...
    public static final class FileProvider4UtilCode extends FileProvider {
        ...
        public boolean onCreate() {
            AndroidUtilCode.init(getContext());
            return true;
        }
    }
