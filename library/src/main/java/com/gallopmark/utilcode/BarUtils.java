...
public class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (AndroidUtilCode.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(tv.data, AndroidUtilCode.getApp().getResources().getDisplayMetrics());
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = AndroidUtilCode.getApp().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = AndroidUtilCode.getApp()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(AndroidUtilCode.getApp()).hasPermanentMenuKey();
    ...
    private static Activity getActivityByView(@NonNull final View view) {
        ...
        LogUtils.e("BarUtils", "the view's Context is not an Activity.");
        return null;
    }
}
