    ...
    public static CommandResult execCmd(final String[] commands,
        ...
        try {
            ...
            if (isNeedResultMsg) {
                ...
                successResult = new BufferedReader(new InputStreamReader(process.getInputStream(), Charset.forName("UTF-8"))); //UTF-8
                errorResult = new BufferedReader(new InputStreamReader(process.getErrorStream(), Charset.forName("UTF-8"))); //UTF-8
                String line;
