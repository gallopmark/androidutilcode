...
public class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) AndroidUtilCode.getApp()
    ...
    public static void reboot() {
        ...
        AndroidUtilCode.getApp().sendBroadcast(intent);
    }
    ...
    public static void reboot(final String reason) {
        PowerManager pm = (PowerManager) AndroidUtilCode.getApp().getSystemService(Context.POWER_SERVICE);
        pm.reboot(reason);
    }
