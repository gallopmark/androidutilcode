...
public class PhoneUtils {
    ...
    public static String getUniqueID() {
        ...
        return TextUtils.isEmpty(serial) ? new UUID(devIDShort.hashCode(), "serial".hashCode()).toString()
                : new UUID(devIDShort.hashCode(), getSerial().hashCode()).toString();
    }
    ...
    public static String getIMEI() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            try {
                ...
                LogUtils.e("PhoneUtils", "getIMEI: ", e);
            }
        }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(AndroidUtilCode.getApp(), 0, new Intent("send"), 0);
    ...
    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) AndroidUtilCode.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    }
