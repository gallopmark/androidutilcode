...
public class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(AndroidUtilCode.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AndroidUtilCode.getApp().getPackageManager()) == null ||
                AndroidUtilCode.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = AndroidUtilCode.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AndroidUtilCode.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AndroidUtilCode.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AndroidUtilCode.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AndroidUtilCode.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, AndroidUtilCode.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, AndroidUtilCode.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, AndroidUtilCode.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, AndroidUtilCode.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return AndroidUtilCode.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return AndroidUtilCode.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = AndroidUtilCode.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(AndroidUtilCode.getApp(), clz));
    }
