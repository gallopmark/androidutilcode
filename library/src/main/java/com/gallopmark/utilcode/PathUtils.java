...
public class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return AndroidUtilCode.getApp().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(AndroidUtilCode.getApp().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AndroidUtilCode.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(AndroidUtilCode.getApp().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(AndroidUtilCode.getApp().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return AndroidUtilCode.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(AndroidUtilCode.getApp().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(AndroidUtilCode.getApp().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return AndroidUtilCode.getApp().getApplicationInfo().dataDir + "shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AndroidUtilCode.getApp().getApplicationInfo().dataDir + "no_backup";
        }
        return getAbsolutePath(AndroidUtilCode.getApp().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppDataPath() {
        if (isExternalStorageDisable()) return "";
        File externalCacheDir = AndroidUtilCode.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodCastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingTonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDCIMPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (isExternalStorageDisable()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(AndroidUtilCode.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(AndroidUtilCode.getApp().getObbDir());
    }
