...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AndroidUtilCode.getApp().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AndroidUtilCode.getApp().getSystemService(Context.TELEPHONY_SERVICE);
            ...
            LogUtils.e("NetworkUtils", "getMobileDataEnabled: ", e);
        }
        return false;
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AndroidUtilCode.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AndroidUtilCode.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    private static boolean isEthernet() {
        final ConnectivityManager cm = (ConnectivityManager) AndroidUtilCode.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) return false;
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) AndroidUtilCode.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AndroidUtilCode.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
