...
public class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final AndroidUtilCode.OnAppStatusChangedListener listener) {
        AndroidUtilCode.getActivityLifecycle().addOnAppStatusChangedListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        AndroidUtilCode.getActivityLifecycle().removeOnAppStatusChangedListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        AndroidUtilCode.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AndroidUtilCode.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = AndroidUtilCode.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        if (isSpace(packageName)) return false;
        try {
            PackageManager pm = AndroidUtilCode.getApp().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return AndroidUtilCode.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        AndroidUtilCode.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = AndroidUtilCode.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(AndroidUtilCode.getApp().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        AndroidUtilCode.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        AndroidUtilCode.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = AndroidUtilCode.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return AndroidUtilCode.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AndroidUtilCode.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = AndroidUtilCode.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(AndroidUtilCode.getApp(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
        AndroidUtilCode.getApp().grantUriPermission(AndroidUtilCode.getApp().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = AndroidUtilCode.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AndroidUtilCode.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AndroidUtilCode.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AndroidUtilCode.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AndroidUtilCode.getApp()
